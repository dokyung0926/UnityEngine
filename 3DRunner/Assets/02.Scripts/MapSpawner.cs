...
public class MapSpawner : MonoBehaviour
{
    ...
    public static void RemveFirstAndSpawnNew()
    {
    ...
    {
        instance = this;
        map.GetComponentsInChildren<Transform>();
    ...
    private void SpawnRandomMapTile()
    {
        ...
        float lastMapTileLength = spawnedMapTiles.Last().GetComponent<BoxCollider>().size.z;
